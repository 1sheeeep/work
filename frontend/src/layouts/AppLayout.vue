...
import { Briefcase, Connection, DataAnalysis, Expand, OfficeBuilding, SwitchButton, User, UserFilled } from '@element-plus/icons-vue'
...
const workspaceLabel = computed(() => ({ organization: '组织管理', 'boss-accounts': 'BOSS 账号', 'job-positions': '职位管理', 'hr-users': 'HR 用户', 'audit-logs': '操作日志' }[String(route.name)] ?? '招聘工作台'))
...
<template>
  <div class="app-layout">
    ...
    <aside class="sidebar">
      ...
      <div class="sidebar-foot"><span>当前闭环</span><strong>职位管理控制台</strong></div>
    </aside>
