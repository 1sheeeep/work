...
function captureLabel(job: JobPosition) { return job.captureSource === 'VISIBLE_PAGE' ? `页面采集${job.captureCompleteness ? ` · ${job.captureCompleteness}/6` : ''}` : '手工录入' }
