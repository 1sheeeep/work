...
- HR 登录后进入招聘概览首页，可直接查看在招职位、候选人、自动跟进账号和浏览器设备指标，并通过分类功能卡片进入业务模块
...
- PostgreSQL Flyway V1–V17 迁移和 Docker Compose 本地/预发布/生产编排
- 桌面与移动端响应式管理界面
...
- 当前主链路已收敛为组织/账号、职位、候选人会话、浏览器设备和超时自动回复。
