...
public record AutoReplyResponse(UUID accountId,String accountName,UUID companyId,String companyName,String accountStatus,String connectionStatus,
        boolean messageSendCapable,boolean monitorOnly,boolean configured,boolean enabled,AwayMode awayMode,Instant awayStartedAt,Instant awayEndsAt,boolean awayActive,boolean autoSendEnabled,int responseTimeoutMinutes,int dailyLimit,
