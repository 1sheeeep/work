...
record BrowserRuntimePolicyResponse(boolean configured,boolean enabled,boolean automaticSend,int timeoutMinutes,int dailyLimit,int sentToday,int minimumIntervalSeconds,String windowStart,String windowEnd,String timezone,String template,Instant serverNow,Instant lastSentAt,Instant pausedUntil){}
