...
public record JobPositionReviewRequest(
        ...
        @Size(max = 40, message = "招聘类型不能超过 40 个字符") String recruitmentType,
        @Size(max = 120, message = "职位类别不能超过 120 个字符") String jobCategory,
        @Size(max = 40, message = "驻外要求不能超过 40 个字符") String overseasRequirement,
        @Size(max = 500, message = "职位关键词不能超过 500 个字符") String jobKeywords,
        @Size(max = 240, message = "工作地址不能超过 240 个字符") String workAddress,
